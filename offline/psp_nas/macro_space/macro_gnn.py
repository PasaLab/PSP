...
from .base_net import GraphNet as BaseNet
from .search_space import act_map
from .base_layer import GeoLayer


class MacroGNN(BaseNet):

    def __init__(self, actions, num_feat, num_label, drop_out=0.6, multi_label=False, batch_normal=True, state_num=5,
                 residual=False):
        self.residual = residual
        self.batch_normal = batch_normal
        super(MacroGNN, self).__init__(actions, num_feat, num_label, drop_out, multi_label, batch_normal, residual,
                                       state_num)
